...
const DishSchema = CollectionSchema(
  ...
  indexes: {},
  links: {},
  embeddedSchemas: {r'DishIngredient': DishIngredientSchema},
  getId: _dishGetId,
...
int _dishEstimateSize(
  ...
  {
    final offsets = allOffsets[DishIngredient]!;
    for (var i = 0; i < object.ingredients.length; i++) {
      final value = object.ingredients[i];
      bytesCount +=
          DishIngredientSchema.estimateSize(value, offsets, allOffsets);
    }
  }
...
void _dishSerialize(
  ...
  writer.writeObjectList<DishIngredient>(
    offsets[0],
    allOffsets,
    DishIngredientSchema.serialize,
    object.ingredients,
  );
...
Dish _dishDeserialize(
  ...
  final object = Dish(
    ingredients: reader.readObjectList<DishIngredient>(
          offsets[0],
          DishIngredientSchema.deserialize,
          allOffsets,
          DishIngredient(),
        ) ??
        [],
...
P _dishDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (reader.readObjectList<DishIngredient>(
            offset,
            DishIngredientSchema.deserialize,
            allOffsets,
            DishIngredient(),
...
extension DishQueryFilter on QueryBuilder<Dish, Dish, QFilterCondition> {
  ...
  QueryBuilder<Dish, Dish, QAfterFilterCondition> ingredientsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Dish, Dish, QAfterFilterCondition> ingredientsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'ingredients',
        0,
  ...
  QueryBuilder<Dish, Dish, QAfterFilterCondition> ingredientsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'ingredients',
        0,
  ...
  QueryBuilder<Dish, Dish, QAfterFilterCondition> ingredientsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Dish, Dish, QAfterFilterCondition> ingredientsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Dish, Dish, QAfterFilterCondition> ingredientsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension DishQueryObject on QueryBuilder<Dish, Dish, QFilterCondition> {
  QueryBuilder<Dish, Dish, QAfterFilterCondition> ingredientsElement(
      FilterQuery<DishIngredient> q) {
    return QueryBuilder.apply(this, (query) {
...
extension DishQueryProperty on QueryBuilder<Dish, Dish, QQueryProperty> {
  ...
  QueryBuilder<Dish, List<DishIngredient>, QQueryOperations>
      ingredientsProperty() {
    return QueryBuilder.apply(this, (query) {
...
const DishIngredientSchema = Schema(
  name: r'DishIngredient',
  id: 2128471795140928299,
  properties: {
    r'name': PropertySchema(
      id: 0,
      name: r'name',
  ...
  estimateSize: _dishIngredientEstimateSize,
  serialize: _dishIngredientSerialize,
  deserialize: _dishIngredientDeserialize,
  deserializeProp: _dishIngredientDeserializeProp,
);

int _dishIngredientEstimateSize(
...
DishIngredient _dishIngredientDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = DishIngredient(
...
P _dishIngredientDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension DishIngredientQueryFilter
    on QueryBuilder<DishIngredient, DishIngredient, QFilterCondition> {
  QueryBuilder<DishIngredient, DishIngredient, QAfterFilterCondition>
      nameIsNull() {
    return QueryBuilder.apply(this, (query) {
...
extension DishIngredientQueryObject
    on QueryBuilder<DishIngredient, DishIngredient, QFilterCondition> {}
